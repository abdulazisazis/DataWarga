                    ...
                    <ul class="list-group list-group-fluish rounded">
                         <a href="dash.php" target="konten" style="text-decoration: none;">
                              <li class="list-group-item list-group-item-action d-flex align-items-center"
                                   ...
                                   <img src="../img/dashboard.png" alt="" class="me-3"
                         ...
                         <a class="text-decoration-none" href="input.php" target="konten">
                              <li class="list-group-item list-group-item-action d-flex align-items-center"
                                   data-bs-toggle="list" role="tab">
                                   <img src="../img/create-list.png" alt="" class="me-2"
                         ...
                         <a href="tampil.php" target="konten" style="text-decoration: none;">
                              <li class="list-group-item list-group-item-action d-flex align-items-center"
                                   data-bs-toggle="list" role="tab">
                                   <img src="../img/personal-information.png" alt="" class="me-2"
                                        style="width: 25px; height: 25px;">
                         ...
                         <a href="rekap.php" target="konten" style="text-decoration: none;">
                              <li class="list-group-item list-group-item-action d-flex align-items-center"
                                   data-bs-toggle="list" role="tab">
                                   <img src="../img/document.png" alt="" class="me-2"
                                        style="width: 25px; height: 25px;">
                                   <span>Rekap</span>
                              </li>
                         </a>

                         <a href="#" onclick="confirmLogout()" style="text-decoration: none;">
                              <li class="list-group-item list-group-item-action d-flex align-items-center"
                                   data-bs-toggle="list" role="tab">
                                   <img src="../img/door-open.png" alt="" class="me-2"
                                        style="width: 25px; height: 25px;">
                                   <span>Keluar</span>
                              </li>
                         </a>
